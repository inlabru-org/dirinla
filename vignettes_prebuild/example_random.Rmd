...
PC-prior(1, 0.01) were employed for standard deviatons hyperparaterms. The generated data did not contain zeros and ones, so we did not use any transformation. 
