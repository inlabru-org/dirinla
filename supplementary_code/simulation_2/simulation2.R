...
ratios1 <- plot_ratios(result_ratio_tot = result_ratio1_tot,
                       param = c("beta01", "beta02", "beta03", "beta04",
...
pdf(paste0("simulation2_ratio1", ".pdf"), width = 15, height = 6)
...
pdf(paste0("simulation2_ratio2", ".pdf"), width = 15, height = 6)
ratios2
dev.off()
...
pdf(paste0("simulation2_ratios", ".pdf"), width = 15, height = 12)
pl_combined
dev.off()
...
pdf(paste0("simulation2_times", ".pdf"), width = 6, height = 4)
pl_combined2
dev.off()
