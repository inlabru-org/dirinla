### In this script simulations with N=500 are conducted in order to check    ###
...
### ------- 3.4.1.1. Using plots --- ####
pdf("example_simulation2_intercepts_500.pdf", width = 20, height = 5)
beta0_not <- expression(beta[0])
p_beta0_not <- expression(paste("p(", beta[0], "|", "y)"))
par(mfrow=c(1,4))
for (i in 1:4)
...
pdf("example_simulation2_intercepts_500.pdf", width = 18, height = 4)
...
pdf("example_simulation2_slopes_500.pdf", width = 18, height = 4)
grid.arrange(p2[[1]], p2[[2]], p2[[3]], p2[[4]], ncol = 4)
dev.off()



pdf("examples_simualtion2_slopes_intercepts_500.pdf", width = 15, height = 6)
