### In this script simulations with N=5000 are conducted in order to check    ###
...
### ------- 3.4.1.1. Using plots --- ####
pdf("example_simulation2_intercepts_5000.pdf", width = 20, height = 5)
...
pdf("example_simulation2_intercepts_5000.pdf", width = 18, height = 4)
...
### ------- 3.4.2. slopes --- ####
### ------- 3.4.2.1. Using plots --- ####
pdf("example_simulation2_slope_5000.pdf", width = 10, height = 3)
...
pdf("example_simulation2_slopes_5000.pdf", width = 18, height = 4)
grid.arrange(p2[[1]], p2[[2]], p2[[3]], p2[[4]], ncol = 4)
dev.off()



pdf("examples_simualtion2_slopes_intercepts_5000.pdf", width = 15, height = 6)
