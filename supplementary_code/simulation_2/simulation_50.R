...
### ------- 3.4.1. intercepts --- ####
### ------- 3.4.1.1. Using plots --- ####
pdf("example_simulation2_intercepts_50.pdf", width = 20, height = 5)
...
### ------- 3.4.2. slopes --- ####
### ------- 3.4.2.1. Using plots --- ####
pdf("example_simulation2_slope_50.pdf", width = 10, height = 3)
...
pdf("examples_simualtion2_slopes_intercepts_50.pdf", width = 15, height = 6)
