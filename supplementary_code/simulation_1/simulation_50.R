...
pdf("example_simulation1_alphas_50.pdf", width = 18, height = 4)
...
### ------- 3.4.3. Means --- ####
### --------- 5.4.3.1. Plot --- ###
pdf("example_simulation_means_50.pdf", width = 20, height = 5)
...
pdf("example_simulation1_mus_50.pdf", width = 18, height = 4)
grid.arrange(p3[[1]], p3[[2]], p3[[3]], p3[[4]], ncol = 4)
dev.off()

pdf("examples_simulation1_beta0_mus_50.pdf", width = 15, height = 6)
