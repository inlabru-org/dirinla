...
```{r, echo = FALSE, eval = TRUE, fig.asp=1, warning=FALSE, fig.width = 5, out.width = '70%', fig.cap = 'Posterior predictive distribution in the simplex. Points represent the original data'}
...
```{r, eval = TRUE, echo = FALSE, fig.asp=0.7, warning=FALSE, fig.width = 10, out.width = '100%', fig.cap = 'Posterior distributions of the parameters. Vertical line represents the real value'}
